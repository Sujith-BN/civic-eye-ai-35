...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Snap a photo, let AI classify and prioritize it, and turn civic problems into verified reports the city can act on." },
      { property: "og:title", content: "FixMyCity — AI-Powered Civic Issue Reporting" },
      { property: "og:description", content: "Transform scattered citizen complaints into structured, verified, prioritized civic intelligence." },
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <div className="min-h-screen flex flex-col">
        ...
        <footer className="border-t border-border/60 bg-secondary/30 py-8 mt-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 flex flex-col md:flex-row items-center justify-between gap-3 text-sm text-muted-foreground">
            <div>© 2026 FixMyCity — Civic Intelligence Platform</div>
